...
# app.config['UPLOAD_FOLDER'] = '/Users/student/Desktop/CS516/merge version/CHTeam/Minizon/MiniAmazon/static/item_images'
app.config["UPLOAD_FOLDER"] = "./MiniAmazon/static/item_images"
db = SQLAlchemy(app)
bcrypt = Bcrypt(app)
